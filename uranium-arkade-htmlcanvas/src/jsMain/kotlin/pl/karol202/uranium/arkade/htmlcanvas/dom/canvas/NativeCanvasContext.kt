...
import pl.karol202.uranium.arkade.htmlcanvas.dom.values.NativeGradient
import pl.karol202.uranium.arkade.htmlcanvas.dom.values.NativePath

internal actual class NativeCanvasContext(private val context: CanvasRenderingContext2D)
{
